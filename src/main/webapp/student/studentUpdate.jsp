			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form class="form-horizontal" role="form" id="frm" action="/studentUpdate" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<img src="/pic?id=${studentVo.id }" style="width:200px; height:200px;"> <%-- picDownloadServlet --%>
					...
					<div class="form-group">
						<label for="id" class="col-sm-2 control-label">호출횟수</label>
						<div class="col-sm-6">
							<label class="control-label">${studentVo.call_cnt }</label>
							<input type="hidden" class="form-control" id="call_cnt" name="call_cnt" value="${studentVo.call_cnt }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<button type="button" class="btn btn-default" id="findAddr">주소찾기</button>
						</div>
					</div>

					<div class="form-group">
							<label class="col-sm-2 control-label" for="addr2">주소2</label>
							<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<input type="hidden" id="zipcdInput" name="zipcd" value="${studentVo.zipcd }">
						</div>
					</div>
